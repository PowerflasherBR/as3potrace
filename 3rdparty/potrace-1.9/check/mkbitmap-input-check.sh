...
INFILES="data1.pbm data1.pgm data1.ppm data1.bmp1 data1.bmp4 data1.bmp8 data1.bmp24 data1.bmp24td data1.bmp24v5 data1.bmp4r data1.bmp8r"

# extract first file
set dummy $INFILES; F="$2"

action $MKBITMAP -o "$TMP1" "$srcdir/$F"
